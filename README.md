...
## 一、概述
這篇文主要是教學如何使用我們學生證即可建立一個簡單且不可竄改的投票機

本篇使用到的技術有:
區塊鏈(solidity)+網頁(node)+IOT(樹梅派)
...
### 展示影片
![image](https://user-images.githubusercontent.com/62298086/148633182-c81c2b7a-5c23-4121-b263-d90b7410f659.png)
https://youtu.be/Pe1V0zN1G2c
